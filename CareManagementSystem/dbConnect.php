...
$myServer = "tcp:dfssjvry4v.database.windows.net,1433";
$myServerWithPort = "dfssjvry4v.database.windows.net,1433";
$serverName = "mssql_elder_care";
$myUser = "accufind@dfssjvry4v";
$myPass = "Lifebook2006";
$myDB = "cms_test"; 
//table names
$tableClient = "client";
...
*/
try {
	$conn = new PDO ( "sqlsrv:server = tcp:dfssjvry4v.database.windows.net,1433; Database = cms_test", "accufind", "Lifebook2006");
	$conn->setAttribute( PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION );
}catch ( PDOException $e ) {  
	print( "Error connecting to SQL Server." );
	die(print_r($e));
